...
return [
    ...
    [
        ...
        'columns' => [
            ...
            'login_token_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
            'token_send_requested' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => false, 'comment' => '', 'precision' => null],
        ],
        'constraints' => [
            'primary' => [
                'type' => 'primary',
