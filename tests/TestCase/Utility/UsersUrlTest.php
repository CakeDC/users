...
class UsersUrlTest extends TestCase
{
    ...
    public function dataProviderActionUrl()
    {
        return [
            ...
            ['resetGoogleAuthenticator', ['prefix' => false, 'plugin' => 'CakeDC/Users', 'controller' => 'Users', 'action' => 'resetGoogleAuthenticator'], null],
            ...
            ['resetGoogleAuthenticator', ['prefix' => false, 'plugin' => false, 'controller' => 'Users', 'action' => 'resetGoogleAuthenticator'], 'Users'],
