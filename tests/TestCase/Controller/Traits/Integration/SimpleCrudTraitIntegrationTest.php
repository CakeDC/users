...
class SimpleCrudTraitIntegrationTest extends TestCase
{
    ...
    public function testCrud()
    {
        ...
        $this->assertResponseContains('method="post" hidden="hidden" action="/users/delete/00000000-0000-0000-0000-000000000001"');
        ...
        $this->assertResponseContains('method="post" hidden="hidden" action="/users/delete/00000000-0000-0000-0000-000000000006"');
