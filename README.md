...
| CakePHP         | CakeDC Users Plugin Branch                               | Tag   | Notes    |
| :-------------: | :------------------------------------------------------: | :--:  | :----    |
| ^4.0            | [develop](https://github.com/cakedc/users/tree/develop)  | -     | unstable |
| ^4.0            | [master](https://github.com/cakedc/users/tree/master)    | 9.0.4 | stable   |
| ^4.0            | [9.0](https://github.com/cakedc/users/tree/9.next)       | 9.0.4 | stable   |
