...
class UserHelper extends Helper
{
    ...
    public function welcome()
    {
        ...
        $label = __d('cake_d_c/users', 'Welcome, {0}', $this->AuthLink->link($this->getView()->getRequest()->getSession()->read('Auth.User.first_name') ?: $this->getView()->getRequest()->getSession()->read('Auth.User.username'), $profileUrl));
